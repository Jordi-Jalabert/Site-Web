<?php
/**
Plugin Name: TechGasp Music Master
Plugin URI: https://wordpress.techgasp.com/spotify-master/
Version: 5.1.0
Author: TechGasp
Author URI: https://wordpress.techgasp.com
Text Domain: spotify-master
Description: TechGasp Music Master allows you to display in your wordpress website musics, playlists and albums of the cool and "booming" music network Spotify.
...
///////DEFINE///////
define( 'SPOTIFY_MASTER_VERSION', '5.1.0' );
define( 'SPOTIFY_MASTER_NAME', 'TechGasp Music Master' );
...
// HOOK ADMIN
require_once( WP_PLUGIN_DIR . '/spotify-master/includes/spotify-master-admin.php');
// HOOK ADMIN ADDONS
require_once( WP_PLUGIN_DIR . '/spotify-master/includes/spotify-master-admin-addons.php');
// HOOK WIDGET BUTTONS
require_once( WP_PLUGIN_DIR . '/spotify-master/includes/spotify-master-widget-buttons.php');
