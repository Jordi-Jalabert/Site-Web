...
Tags: plugin, mixcloud, sound, music, mp3, wav, player, playlist, embedded, podcast, dj mix, radio
Requires at least: 3.5
Tested up to: 5.2.3
Stable tag: 5.1.0
License: GPLv2 or later

TechGasp Mix Master is the wordpress plugin that you need to display mixcloud real-time streaming services.


== Description ==

Mix Master is easy to use and interactive. It quickly allows you to integrate live mixcloud radio shows, Dj mixes and podcasts into your Wordpress.

These are the main options we packed into this extension. Mix Basic Player widget for easy deployment and fast loading times. Mix User Profile widget to easily gather followers and listeners.
...
**Mix Master... Mixcloud Radio and Podcasts for wordpress**
...
* Mix Basic Player Widget options
* Display, Hide or Change Widget Title
* Option to Activate Streaming Player


**ADVANCED Version Contains**

* Mix User Profile Widget options
* Display, Hide or Change Widget Title
* Option to Activate User Profile Display
* Profile Colour Scheme (light or dark)
...
* Mix Advanced Responsive Player Widget
...
* Display Track List
* Display Artwork
* Activate TechGasp BANG! Artwork, for users with great Artcovers, WOW!

* Mix Advanced Responsive Mini Player Widget
* Fully Mobile Responsive
* Display, Hide or Change Widget Title
* Option to Activate Streaming Player
* Player Colour Scheme
...
* Mix Admin Dashboard Widget
* Cool player widget to listen to your favourite mixcloud radio and podcasts while working on your Wordpress Administrator
...
* [Advanced Version Link](https://wordpress.techgasp.com/mix-master/)

**ONLINE DEMO**

* Right of the page, sidebar widget
* Inside the post, with shortcode framework v5
* [Demo Link](https://wordpress.techgasp.com/mix-master/)
...
3. Visit the "Widget Page | Mix Master Widgets" to configure widget settings and your template widget positions.
4. [Mix Master Documentation](https://wordpress.techgasp.com/mix-master-documentation)
...
= Need More Help =
* [Mix Master Documentation](https://wordpress.techgasp.com/mix-master-documentation)
...
= 5.0 =
* Version 5.0 contained 15 releases (5.0 to 5.0.15) please view changelog online
