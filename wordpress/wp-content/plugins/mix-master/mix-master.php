<?php
/**
Plugin Name: TechGasp Mix Master
Plugin URI: https://wordpress.techgasp.com/mix-master/
Version: 5.1.0
Author: TechGasp
Author URI: https://wordpress.techgasp.com
Text Domain: mix-master
Description: TechGasp Mix Master is the wordpress plugin that you need to display mixcloud real-time streaming services.
...
///////DEFINE///////
define( 'MIX_MASTER_VERSION', '5.1.0' );
define( 'MIX_MASTER_NAME', 'TechGasp Mix Master' );
...
// HOOK ADMIN
require_once( WP_PLUGIN_DIR . '/mix-master/includes/mix-master-admin.php');
// HOOK ADMIN ADDONS
require_once( WP_PLUGIN_DIR . '/mix-master/includes/mix-master-admin-addons.php');
// HOOK WIDGET BASIC
require_once( WP_PLUGIN_DIR . '/mix-master/includes/mix-master-widget-basic.php');
